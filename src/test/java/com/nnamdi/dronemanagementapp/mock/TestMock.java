...
public class TestMock {
    ...
    public static RegisterDroneDto registerDroneDto() {
        return RegisterDroneDto.builder().direction(Direction.WEST).coordinateX(4).coordinateY(4).name(DRONE_NAME).build();
    }

    public static RegisterDroneDto registerDroneBadRequestDto() {
        return RegisterDroneDto.builder().direction(Direction.WEST).name(DRONE_NAME).coordinateX(-10).coordinateY(10).build();
    }


    public static DroneDto buildDroneDto() {
        return DroneDto.builder().direction(Direction.WEST).coordinateX(10).coordinateY(10).name(DRONE_NAME).id(ID).build();
    }
    ...
    public static UpdateDronePositionDto updateDronePositionDto() {
        return UpdateDronePositionDto.builder().coordinateX(9).coordinateY(8).direction(Direction.WEST).build();
    }
}
